...
$login = new Login(new DB(new PDO("mysql:host=localhost;dbname=veronicadb;port=3306","sk123","Sk123&*("),"mysql:host=localhost;dbname=veronicadb;port=3306","sk123","Sk123&*("), new Helpers(),[],"");
$login->getDBConn();
$login->login();
?>
                    ...
                    <form action="login.php" method="POST" novalidate>
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="email" id="email" name="email" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="email-error" value="<?= $login->email; ?>">
                                ...
                                <?php if (isset($login->errors['email'])) : ?>
                                    <p class="text-xs text-red-600 mt-2" id="email-error"><?= $login->errors['email']; ?></p>
                                <?php endif; ?>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div>
                                ...
                                <?php if (isset($login->errors['password'])) : ?>
                                    <p class="text-xs text-red-600 mt-2" id="password-error"><?= $login->errors['password']; ?></p>
                                <?php endif; ?>
                            </div>
                            <!-- End Form Group -->
